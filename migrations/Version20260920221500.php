...
final class Version20260920221500 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE media_asset ADD CONSTRAINT FK_MEDIA_ASSET_FOLDER FOREIGN KEY (folder_id) REFERENCES media_folder (id) ON DELETE RESTRICT NOT DEFERRABLE INITIALLY IMMEDIATE');
