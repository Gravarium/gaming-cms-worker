...
class MediaAssetReplica
{
    ...
    public function setTargetKey(string $key): self { $this->targetKey = strtolower(trim($key)); return $this; }
    public function getProviderKey(): string { return $this->providerKey; }
    public function setProviderKey(string $key): self { $this->providerKey = strtolower(trim($key)); return $this; }
    public function getObjectKey(): string { return $this->objectKey; }
    public function setObjectKey(string $key): self { $this->objectKey = ltrim(trim($key), '/'); return $this; }
